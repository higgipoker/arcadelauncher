...
// make_amiga_game
// ------------------------------------------------------------
std::string Resources::make_amiga_game(const std::string &_games_folder, const std::string &_kicks_folder, const std::string &_game_name,
...
Icon *Resources::make_icon(const std::string &search_dir, const std::string &name) {
  ...
  if (icon == NULL) {
    icon = new GenericIcon(SDL::window(), name, Config::data.generic_icon, Config::data.icon_border, Config::data.icon_border_lit);
  }
